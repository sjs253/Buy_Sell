...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post commodities_url, params: { commodity: { item_description: @commodity.item_description, item_name: @commodity.item_name, price: @commodity.price } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { item_description: @commodity.item_description, item_name: @commodity.item_name, price: @commodity.price } }
